...
public class RotationWatcher extends Thread {
    ...
    public synchronized void report(int rotation) {
        // The internal values are very convenient, we can simply multiply by 90 to get the
        // actual degree.
        System.out.println(rotation * 90);
        listener.onChange(rotation * 90);

    }

    public void setOnOrientationChangeListener(OrientationChangeListener listener) {
